...
export const fruitsArray: Product[] = [
  {
    title: "Apple",
    category: "fruits",
    imgCode: "apple",
  ...
  },
  {
    ...
    category: "fruits",
    imgCode: "grapefruit",
    description: `The grapefruit is a subtropical citrus tree known for its relatively large, sour to semi-sweet, somewhat bitter fruit. The interior flesh is segmented and varies in color from pale yellow to dark pink.
        Grapefruit is a citrus hybrid originating in Barbados. It is an accidental cross between the sweet orange and the pomelo or shaddock, both of which were introduced from Asia in the 17th century. It has also been called the forbidden fruit. In the past it was referred to as the pomelo, but that term is now mostly used as the common name for Citrus maxima`,
    price: "3.50",
  },
  {
    title: "Grapes",
  ...
  },
  {
    ...
    category: "fruits",
    imgCode: "papaya",
    description: `The papaya or pawpaw  is the plant species Carica papaya, one of the 21 accepted species in the genus Carica of the family Caricaceae. It was first domesticated in Mesoamerica, within modern-day southern Mexico and Central America. In 2020, India produced 43% of the world's supply of papayas.`,
    price: "8.90",
  },
  {
    title: "Peach",
...
The pineapple is indigenous to South America, where it has been cultivated for many centuries. The introduction of the pineapple to Europe in the 17th century made it a significant cultural icon of luxury. Since the 1820s, pineapple has been commercially grown in greenhouses and many tropical plantations.`,
  ...
  },
  {
    ...
    category: "fruits",
    imgCode: "plum",
    description: `A plum is a fruit of some species in Prunus subg. Prunus. Dried plums are most often called prunes, though after the year 2000 in the United States they may be just labeled as 'dried plums'. Plum flowers Plum unripe fruits
...
`,
  ...
  },
  {
    ...
    category: "fruits",
    imgCode: "watermelon",
    description: `Watermelon (Citrullus lanatus) is a flowering plant species of the Cucurbitaceae family and the name of its edible fruit. A scrambling and trailing vine-like plant, it is a highly cultivated fruit worldwide, with more than 1,000 varieties.
